...
def DCE_net(scale_factor=1, device='cuda'):
    ...
    _DCE_net.load_state_dict(torch.hub.load_state_dict_from_url(checkpoint, map_location='cpu'))

    return _DCE_net.to(device)
